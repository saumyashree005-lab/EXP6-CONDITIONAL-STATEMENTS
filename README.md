...
- If first is greatest, print it
- Else if second is greatest, print it
...
- Else if year divisible by 4 and not divisible by 100, it is a leap year
...
- Check leap year and update February days if required
- Increase day by 1
